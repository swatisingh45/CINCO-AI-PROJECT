...
public class InternalAIProjectGratextLexer extends Lexer {
    ...
    public final void mRULE__ID() throws RecognitionException {
        try {
            int _type = RULE__ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:575:10: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )* )
            // InternalAIProjectGratext.g:575:12: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            {
            // InternalAIProjectGratext.g:575:12: ( '^' )?
            int alt1=2;
            ...
            // InternalAIProjectGratext.g:575:41: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE__SIGN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:577:12: ( ( '+' | '-' ) )
            // InternalAIProjectGratext.g:577:14: ( '+' | '-' )
            {
    ...
    public final void mRULE__INT() throws RecognitionException {
        try {
            int _type = RULE__INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:579:11: ( ( '0' .. '9' )+ )
            // InternalAIProjectGratext.g:579:13: ( '0' .. '9' )+
            {
            // InternalAIProjectGratext.g:579:13: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalAIProjectGratext.g:579:14: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE__STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:581:14: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalAIProjectGratext.g:581:16: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalAIProjectGratext.g:581:16: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalAIProjectGratext.g:581:17: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalAIProjectGratext.g:581:21: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalAIProjectGratext.g:581:22: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalAIProjectGratext.g:581:29: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalAIProjectGratext.g:581:49: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalAIProjectGratext.g:581:54: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalAIProjectGratext.g:581:55: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalAIProjectGratext.g:581:62: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE__ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:583:18: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalAIProjectGratext.g:583:20: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalAIProjectGratext.g:583:25: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalAIProjectGratext.g:583:53: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE__SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:585:18: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalAIProjectGratext.g:585:20: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalAIProjectGratext.g:585:25: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalAIProjectGratext.g:585:41: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalAIProjectGratext.g:585:42: ( '\\r' )? '\\n'
                    {
                    // InternalAIProjectGratext.g:585:42: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE__WS() throws RecognitionException {
        try {
            int _type = RULE__WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:587:10: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalAIProjectGratext.g:587:12: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalAIProjectGratext.g:587:12: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE__ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAIProjectGratext.g:589:17: ( . )
            // InternalAIProjectGratext.g:589:19: .
            {
            matchAny(); 
