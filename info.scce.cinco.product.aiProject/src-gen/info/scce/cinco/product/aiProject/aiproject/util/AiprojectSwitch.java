 ...
 * @generated
 */
public class AiprojectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AiprojectPackage.AI_PROJECT: {
				AIProject aiProject = (AIProject)theEObject;
				T result = caseAIProject(aiProject);
				if (result == null) result = caseGraphModel(aiProject);
				if (result == null) result = caseModelElementContainer(aiProject);
				if (result == null) result = caseIdentifiableElement(aiProject);
