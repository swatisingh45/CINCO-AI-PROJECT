...
public class ViewsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ViewsSwitch<Adapter> modelSwitch =
		new ViewsSwitch<Adapter>() {
			@Override
			public Adapter caseAIProjectView(AIProjectView object) {
				return createAIProjectViewAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.aiProject.aiproject.views.AIProjectView <em>AI Project View</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAIProjectViewAdapter() {
		return null;
	}
