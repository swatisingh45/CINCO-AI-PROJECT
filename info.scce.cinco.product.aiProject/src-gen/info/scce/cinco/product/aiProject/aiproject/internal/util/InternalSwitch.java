...
public class InternalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InternalPackage.INTERNAL_AI_PROJECT: {
				InternalAIProject internalAIProject = (InternalAIProject)theEObject;
				T result = caseInternalAIProject(internalAIProject);
				if (result == null) result = caseInternalGraphModel(internalAIProject);
				if (result == null) result = caseInternalModelElementContainer(internalAIProject);
				if (result == null) result = caseInternalIdentifiableElement(internalAIProject);
